...
| [0020](0020-component-scope.md) | Component-scope: lightweight third tier (one `<slug>-maintainer`, state on GitHub, registry in config) for library/MCP/toolbox repos | Proposed | 2026-06-22 |
